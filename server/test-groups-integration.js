...
async function apiFetchRaw(endpoint, token, options = {}) {
    const headers = { 'Content-Type': 'application/json', 'Authorization': `Bearer ${token}`, ...options.headers };
...
async function runTests() {
    ...
    try {
        ...
        if (resBAdd.status !== 403)
            throw new Error('Non-admin was able to add a member!');
...
runTests();
//# sourceMappingURL=test-groups-integration.js.map